...
public class MetroStopTest extends TestCase{
	...
	public void testNameComparator() {
		...
		metroStops.add(new MetroStop(1, 0.55, 0.101, "Shusaku", "BadukCity", "tram"));
		...
		metroStops.add(new MetroStop(4, 0.55, 0.101, "Kisei", "BadukCity", "tram"));
		...
		metroStops.add(new MetroStop(8, 0.55, 0.101, "Mingren", "BadukCity", "tram"));
